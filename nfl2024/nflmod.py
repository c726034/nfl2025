...
def get_picks(picksday='X', w = None):
    ...
    # NFL week to process (default is curent NFL week)
    ...
    weekpicks = weekpicks[['timestamp','name']].merge(weekpicks['picks'].str.split("\),",expand=True),left_index=True, right_index=True)
